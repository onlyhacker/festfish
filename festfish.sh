#!/bin/bash
# festfish v1.0
# Powered by OnlyHacker/Awoken Tech
# Credits goes to [github.com/thelinuxchoice/]
...
clear
figlet "Fest Fish"
printf " \e[1;77m www.awokentech.blogspot.com OR www.github.com/onlyhacker | youtube.com/awokentech \e[0m \n"
